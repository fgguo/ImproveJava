package main.java.com.demo.reflect;
...
public class SimpleReflectDemo {
    ...
    public static void main(String[] args) {
        Student student = new Student(19,90d,"张三");
        String str = SimpleMapper.toString(student);
        System.out.println(str);
        Student student1 = (Student) SimpleMapper.fromString(str);
